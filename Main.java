...
import ev2.recuperacion.Animal.SEXO;
...
public class Main {
	public static void main(String[] args) throws InterruptedException {
		...
		Animal perro1= new Perro(SEXO.MACHO, propietario1, "Coke", "Schnauzer", 8, 9.2, "P1");
		Animal perro1= new Perro(8, SEXO.MACHO, 9.2, propietario1, "Coke", 9, );
		Animal perro2= new Perro( SEXO.MACHO, propietario1, "Chico", "Chucho", 12, 11.1, "P2");
	
		Animal gato1= new Gato( SEXO.MACHO, propietario1, "Pussy", "Angora", 3, 3.2, "G1");
		Animal bicha1= new Serpiente( SEXO.HEMBRA, propietario1, "Cobra", true);
		...
		consulta1.getMedicamentosByGramos(); //Orden descendente usando el compareTo de Medicamento, por peso
